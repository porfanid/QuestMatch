...
const config = {
  title: 'QuestMatch',
  tagline: 'Find the group you are meant to play DND with',
  ...
  organizationName: 'porfanid', // Usually your GitHub org/user name.
  projectName: 'QuestMatch', // Usually your repo name.
    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/porfanid/QuestMatch/',
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/QuestMatch.png',
      navbar: {
        title: 'QuestMatch',
        logo: {
          alt: 'Answer the call',
          src: 'img/QuestMatch.png',
        },
        items: [
          {
            type: 'docSidebar',
          ...
          {
            href: 'https://github.com/porfanid/QuestMatch',
            label: 'GitHub',
            position: 'right',
          },
        ],
